...
pause.addEventListener('click', pauseOrResumeCount);
...
function pauseOrResumeCount () {
    ...
    toggleActivities(notPauseButton);
}

function toggleActivities(notPauseButton) {
    notPauseButton.forEach(button => button.disabled = isActive);
    isActive = !isActive;
}
